-- Hasta ahora el monto vendido a Cta. Corriente en cada turno se calculaba al
-- vuelo solo para mostrarlo en el modal de cierre ("no concilia contra caja")
-- y se perdia -- no quedaba en ningun lado para poder verlo despues en el
-- Informe de cierres. Se persiste en cierres_caja.total_fiado.
--
...
alter table public.cierres_caja add column total_fiado numeric not null default 0;
...
begin
  ...
  insert into cierres_caja (
    ...
    retiros_turno, notas, created_by, fondo_siguiente, numero_liquidacion, total_fiado
  ) values (
    ...
    v_retiros_turno, p_notas, p_created_by, p_fondo_siguiente, v_numero_liquidacion, p_total_fiado
  )
