...
export const metadata: Metadata = { title: "Socios — Kioscos IDEIA" };
export const revalidate = 0;

// Índice para llegar directo desde el menú -- Socios en sí sigue viviendo por
// sucursal (/admin/sucursales/[id]/socios), esto solo evita tener que entrar
// primero a un kiosco puntual para encontrarlo.
export default async function SociosIndexPage() {
  ...
  if (role === "encargado") {
    ...
    redirect(`/admin/sucursales/${suc.id}/socios`);
  }
  ...
  return (
    <div className="p-4 md:p-8 max-w-lg">
      <div className="mb-6">
        <h1 className="text-xl md:text-2xl font-semibold font-display text-neutral-900">Socios</h1>
      ...
      <div className="space-y-2">
        {(sucursales ?? []).map((s) => (
          <Link
            key={s.id}
            href={`/admin/sucursales/${s.id}/socios`}
