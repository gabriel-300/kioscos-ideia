...
export default async function SucursalDetailPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ mes?: string }> }) {
  ...
  // significa "todas" (comportamiento de siempre). Se calcula acá arriba
  ...
  // categoriasHabilitadas ya se calculó más arriba (también filtra promos).
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl">
      ...
      <div className="mb-6 flex flex-wrap gap-3">
        ...
        {/* Socios: NUNCA para concesionario -- son los retiros de los socios
            reales del negocio, no algo que le corresponda ver ni tocar. */}
